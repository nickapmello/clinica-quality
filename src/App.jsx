...
export default function App() {
  ...
  const [shufflerItems, setShufflerItems] = useState([
    { id: 1, title: 'Fisioterapia Ortopédica', desc: 'Acompanhamento focado em reabilitação de coluna e articulações', badge: 'Cuidado Dedicado' },
    { id: 2, title: 'Liberação Miofascial', desc: 'Técnicas voltadas à redução de tensões musculares e mobilidade', badge: 'Manual & Instrumental' },
    { id: 3, title: 'Pilates Clínico & RPG', desc: 'Reabilitação postural, fortalecimento do core e flexibilidade', badge: 'Estabilização' },
  ]);

  // States for Typewriter (Card 2) - Clinical Evolution without absolute promises
  const [telemetryText, setTelemetryText] = useState('');
  const telemetryMessages = [
    "Avaliação funcional individualizada realizada para compreender suas necessidades...",
    "Aplicação de técnicas voltadas à redução de tensões e evolução gradual da mobilidade...",
    "Fortalecimento progressivo e estabilização da postura com Pilates Clínico...",
    "Estímulo à autonomia e auxílio no retorno gradual e seguro às atividades diárias..."
  ];
  ...
  return (
    <div className="relative w-full min-h-screen bg-[#F7FAFC] text-[#17212B] font-sans selection:bg-[#1769AA] selection:text-white">
      ...
      <header className="fixed top-5 left-1/2 -translate-x-1/2 z-50 w-[92%] max-w-6xl transition-all duration-300">
        <div className={`flex items-center justify-between px-6 py-3 rounded-full transition-all duration-300 ${
          ...
          <a href="#" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              ...
              <span className={`text-[10px] tracking-widest uppercase font-mono-data opacity-80 ${navScrolled ? 'text-[#0B3D66]' : 'text-white/80'}`}>
          ...
          <nav className={`hidden md:flex items-center gap-8 text-sm font-medium ${navScrolled ? 'text-[#0B3D66]' : 'text-white/90'}`}>
            ...
            <a href="#filosofia" className="hover:text-[#1769AA] transition-colors">Nossa Forma de Cuidar</a>
          ...
          <a 
            ...
            className="hidden md:inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#1769AA] hover:bg-[#0B3D66] text-white text-xs font-semibold uppercase tracking-wider magnetic-btn btn-sliding-bg shadow-md shadow-[#1769AA]/30"
          >
          ...
          <button 
            ...
            className={`md:hidden p-2 rounded-full ${navScrolled ? 'text-[#0B3D66]' : 'text-white'}`}
          >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-3 p-6 rounded-3xl bg-[#0B3D66] text-white border border-white/10 shadow-2xl flex flex-col gap-4 animate-in fade-in slide-in-from-top-4">
            ...
            <a href="#filosofia" onClick={() => setMobileMenuOpen(false)} className="text-lg font-medium hover:text-sky-300">Nossa Forma de Cuidar</a>
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-2 text-center py-3 rounded-full bg-[#1769AA] text-white font-semibold flex items-center justify-center gap-2"
            >
      ...
      <section ref={heroRef} className="relative min-h-[100dvh] flex flex-col justify-end pt-32 pb-16 px-6 md:px-16 overflow-hidden bg-[#0B3D66] text-white rounded-b-[3rem] shadow-2xl">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#06243E] via-[#0B3D66]/90 to-transparent" />
        </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto md:mx-0">
          ...
          <p className="hero-anim text-base md:text-xl text-white/80 max-w-2xl font-normal mb-8 leading-relaxed">
            Fisioterapia Ortopédica, Liberação Miofascial, RPG e Pilates Clínico. 
            Entenda a origem do desconforto e recupere seus movimentos com acompanhamento individualizado no centro de Londrina.
          </p>
          ...
          <div className="hero-anim flex flex-wrap items-center gap-4">
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-4 rounded-full bg-[#1769AA] hover:bg-[#06243E] text-white font-semibold text-sm uppercase tracking-wider magnetic-btn btn-sliding-bg shadow-lg shadow-[#1769AA]/40 flex items-center gap-3"
            >
              <MessageCircle className="w-5 h-5" />
        ...
        <div className="hero-anim relative z-10 grid grid-cols-2 md:grid-cols-4 gap-4 pt-12 mt-12 border-t border-white/10 max-w-5xl">
          ...
          <div>
            <span className="block text-2xl md:text-3xl font-bold text-sky-300 font-mono-data">Fisioterapia</span>
            <span className="text-xs text-white/70">Atendimento Personalizado</span>
          </div>
          <div>
          ...
          <div>
            <span className="block text-2xl md:text-3xl font-bold text-sky-300 font-mono-data">Rua Santos</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {shufflerItems.map((item, idx) => (
                  <div
                    ...
                    style={{
                      ...
                      zIndex: 30 - idx * 10,
                      opacity: 1 - idx * 0.2,
                      backgroundColor: idx === 0 ? '#0B3D66' : '#EAF4FB',
                      color: idx === 0 ? '#FFFFFF' : '#17212B',
                      borderColor: idx === 0 ? '#1769AA' : 'rgba(11, 61, 102, 0.15)'
                    }}
                  >
                    <div className="flex justify-between items-start mb-2">
                      <span className="font-bold text-sm">{item.title}</span>
                      <span className={`text-[10px] font-mono-data px-2 py-0.5 rounded-full ${idx === 0 ? 'bg-[#1769AA] text-white' : 'bg-[#0B3D66]/10 text-[#0B3D66]'}`}>
                        {item.badge}
                      </span>
                    </div>
                    <p className={`text-xs ${idx === 0 ? 'text-white/80' : 'text-[#17212B]/70'}`}>{item.desc}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="bg-[#0B3D66] text-white border border-white/15 rounded-[2.5rem] p-8 shadow-2xl flex flex-col justify-between hover:border-[#1769AA]/50 transition-all group">
            <div>
              ...
              <p className="text-sm text-white/70 mb-6">
                Técnicas manuais e instrumentais direcionadas para alívio de tensões musculares e melhora da flexibilidade fascial.
              </p>

              {/* Typewriter Display — Clinical Evolution without absolute promises */}
              <div className="bg-[#06243E] rounded-2xl p-5 border border-white/10 font-mono-data text-xs text-sky-300 min-h-[140px] flex flex-col justify-between relative overflow-hidden">
                ...
                <div className="flex-1">
                  <p className="leading-relaxed text-sky-200">
                    {telemetryText}
                    <span className="inline-block w-2 h-4 bg-[#1769AA] ml-1 animate-pulse" />
                  </p>
                </div>
                <div className="text-[10px] text-white/40 pt-2 flex justify-between">
                  <span>Quality Fisioterapia</span>
                  <span className="text-sky-300">Londrina/PR</span>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white border border-[#0B3D66]/15 rounded-[2.5rem] p-8 shadow-xl shadow-[#0B3D66]/5 flex flex-col justify-between hover:border-[#1769AA]/40 transition-all group">
            <div>
              ...
              <h3 className="text-xl font-bold text-[#17212B] mb-2">Pilates Clínico & Estabilização</h3>
              <p className="text-sm text-[#17212B]/70 mb-6">
              ...
              <div className="relative bg-[#F7FAFC] rounded-2xl p-5 border border-[#0B3D66]/10 shadow-inner min-h-[140px]">
                    ...
                    return (
                      <div
                        ...
                        className={`p-2 rounded-xl text-center text-xs font-bold font-mono-data transition-all ${
                          isSel 
                            ? 'bg-[#1769AA] text-white shadow-md shadow-[#1769AA]/30 scale-105' 
                            : 'bg-[#EAF4FB] text-[#17212B]/80 border border-[#0B3D66]/10'
                        }`}
                      >
                        {day}
                      </div>
                ...
                <div className="flex justify-between items-center bg-[#0B3D66] text-white px-4 py-2 rounded-xl text-xs font-mono-data">
                  <span>Horários: 07h às 20h</span>
                  <span className="bg-[#1769AA] text-white text-[10px] px-2 py-0.5 rounded-full font-bold">
                    Salvar Horário
                  </span>
                </div>
                ...
                >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="drop-shadow-md">
                    <path d="M5.5 3.5L18.5 12L12.5 13.5L16 20.5L13.5 21.5L10 14.5L5.5 18V3.5Z" fill="#1769AA" stroke="white" strokeWidth="1.5"/>
                  </svg>
                </div>
              </div>
            </div>
      ...
      <section id="filosofia" ref={philosophyRef} className="py-32 px-6 md:px-16 bg-[#0B3D66] text-white rounded-[3rem] my-12 relative overflow-hidden shadow-2xl border border-white/10">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          <span className="px-4 py-1.5 rounded-full bg-white/10 text-sky-300 font-mono-data text-xs uppercase font-semibold tracking-widest border border-white/15">
            Nossa Forma de Cuidar
          </span>

          <div className="mt-12 space-y-8">
            <p className="philosophy-text text-xl md:text-3xl text-white/80 font-light leading-relaxed">
              Cada pessoa possui uma história, uma rotina e necessidades diferentes.
            </p>
            
            <p className="philosophy-text text-3xl md:text-5xl lg:text-6xl font-normal leading-tight">
              <span className="font-sans text-white">Na Quality,</span>{' '}
              <span className="font-drama text-sky-300 text-4xl md:text-6xl lg:text-7xl block md:inline mt-2 md:mt-0">
                o atendimento começa com uma avaliação individualizada para compreender suas necessidades e definir uma estratégia de cuidado adequada para cada etapa da evolução.
              </span>
            </p>
          </div>
          ...
          <div className="philosophy-text mt-16 pt-12 border-t border-white/10 grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
              <ShieldCheck className="w-8 h-8 text-sky-300 mb-3" />
              <h4 className="font-bold text-lg text-white mb-1">Avaliação Biomecânica</h4>
              <p className="text-xs text-white/70">Mapeamento para compreender as dinâmicas do seu movimento.</p>
            </div>
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
              <Sparkles className="w-8 h-8 text-sky-300 mb-3" />
              <h4 className="font-bold text-lg text-white mb-1">Cuidado Individualizado</h4>
              <p className="text-xs text-white/70">Atendimento conduzido e adaptado por fisioterapeutas para cada etapa do tratamento.</p>
            </div>
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
              <Award className="w-8 h-8 text-sky-300 mb-3" />
              <h4 className="font-bold text-lg text-white mb-1">Nota 4.8 no Google</h4>
              <p className="text-xs text-white/70">Reconhecimento e carinho demonstrados por pacientes em Londrina.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="protocolo" ref={protocolRef} className="py-24 px-6 md:px-16 max-w-6xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-base md:text-lg text-[#17212B]/70">
            Conheça o processo passo a passo desenhado para apoiar a recuperação da sua mobilidade.
          </p>
        </div>
        ...
        <div className="space-y-12">
          ...
          <div className="sticky-card sticky top-28 bg-[#0B3D66] text-white p-8 md:p-14 rounded-[3rem] shadow-2xl border border-white/10 flex flex-col md:flex-row justify-between items-center gap-10">
            <div className="flex-1">
              ...
              <ul className="space-y-2 text-xs font-mono-data text-white/90">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-sky-300" /> Avaliação postural minuciosa</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-sky-300" /> Teste de amplitude de movimento</li>
              </ul>
            </div>
            ...
            <div className="w-48 h-48 rounded-3xl bg-white/5 border border-white/10 flex items-center justify-center relative overflow-hidden">
              <svg className="w-32 h-32 animate-[spin_20s_linear_infinite]" viewBox="0 0 100 100">
                <circle cx="50" cy="50" r="45" fill="none" stroke="#1769AA" strokeWidth="2" strokeDasharray="6 6" />
          ...
          <div className="sticky-card sticky top-32 bg-[#06243E] text-white p-8 md:p-14 rounded-[3rem] shadow-2xl border border-white/10 flex flex-col md:flex-row justify-between items-center gap-10">
            <div className="flex-1">
              ...
              <p className="text-white/80 text-sm md:text-base leading-relaxed mb-6">
                Aplicação de técnicas manuais para redução de tensões em fáscias e músculos, favorecendo o reequilíbrio postural e o alívio articular.
              </p>
              <ul className="space-y-2 text-xs font-mono-data text-white/90">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-sky-300" /> Terapia manual para redução de tensões</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-sky-300" /> Estímulo à flexibilidade muscular</li>
              </ul>
            </div>
          ...
          <div className="sticky-card sticky top-36 bg-[#0B3D66] text-white p-8 md:p-14 rounded-[3rem] shadow-2xl border border-white/10 flex flex-col md:flex-row justify-between items-center gap-10">
            <div className="flex-1">
              ...
              <p className="text-white/80 text-sm md:text-base leading-relaxed mb-6">
                Trabalhamos fortalecimento, estabilidade e consciência corporal para favorecer um retorno mais seguro às atividades diárias.
              </p>
              <ul className="space-y-2 text-xs font-mono-data text-white/90">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-sky-300" /> Músculos do CORE fortalecidos</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-sky-300" /> Favorecimento da autonomia e estabilidade corporal</li>
              </ul>
            </div>
      ...
      <section className="py-24 px-6 md:px-16 max-w-6xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-base text-[#17212B]/70">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          {/* Card Pricing 1 */}
          <div className="bg-white p-8 rounded-[2.5rem] border border-[#0B3D66]/15 shadow-lg flex flex-col justify-between h-full">
            <div>
              <span className="text-xs font-mono-data text-[#0B3D66] uppercase tracking-wider font-bold">AVULSO / SOB DEMANDA</span>
              <h3 className="text-2xl font-bold mt-2 mb-3 text-[#17212B]">Sessão Fisioterápica</h3>
              <p className="text-xs text-[#17212B]/70 mb-6">Ideal para alívio pontual de tensão muscular ou avaliação inicial.</p>
              
              <ul className="space-y-3 text-xs text-[#17212B]/80 mb-8">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-[#0B3D66]" /> Avaliação Fisioterapêutica</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-[#0B3D66]" /> Liberação Miofascial dedicada</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-[#0B3D66]" /> Orientação de postura e exercícios</li>
              </ul>
            </div>
            <a 
              href={whatsappUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="w-full text-center py-3.5 rounded-full bg-[#0B3D66] hover:bg-[#1769AA] text-white font-semibold text-xs uppercase tracking-wider magnetic-btn"
            >
              Consultar Valores
            </a>
          </div>
          ...
          <div className="bg-[#0B3D66] text-white p-8 md:p-10 rounded-[2.5rem] shadow-2xl border-2 border-[#1769AA] relative flex flex-col justify-between h-full transform md:-translate-y-4">
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#1769AA] text-white text-[11px] font-bold font-mono-data uppercase px-4 py-1 rounded-full shadow-md">
              Mais Recomendado
            </div>
            <div>
              <span className="text-xs font-mono-data text-sky-300 uppercase tracking-wider font-bold block mt-2">TRATAMENTO COMPLETO</span>
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full text-center py-4 rounded-full bg-[#1769AA] hover:bg-[#06243E] text-white font-bold text-xs uppercase tracking-wider magnetic-btn shadow-lg shadow-[#1769AA]/40"
            >
              Agendar no WhatsApp
            </a>
          </div>
          ...
          <div className="bg-white p-8 rounded-[2.5rem] border border-[#0B3D66]/15 shadow-lg flex flex-col justify-between h-full">
            <div>
              ...
              <ul className="space-y-3 text-xs text-[#17212B]/80 mb-8">
                ...
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-[#0B3D66]" /> Treinamento funcional adaptado</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-[#0B3D66]" /> Supervisão constante de fisioterapeuta</li>
              </ul>
            </div>
            <a 
              href={whatsappUrl}
      ...
      {/* G. DEPOIMENTOS / PROVA SOCIAL GOOGLE (4.8 ★ REAIS) */}
      <section id="avaliacoes" className="py-24 px-6 md:px-16 bg-[#EAF4FB] rounded-[3rem] my-12 max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#0B3D66] text-white font-mono-data text-xs mb-3">
            <Star className="w-4 h-4 fill-amber-400 text-amber-400" />
            <span>Nota 4.8 de 5 no Google Reviews</span>
          </div>
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-[#17212B]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-3xl border border-[#0B3D66]/10 shadow-md flex flex-col justify-between">
            <p className="text-sm text-[#17212B]/80 italic mb-6 leading-relaxed">
              "Cheguei com fortes dores na coluna lombar e mal conseguia sentar. O atendimento da Quality mudou minha rotina. Em poucas sessões de liberação miofascial e pilates senti uma excelente melhora na qualidade dos movimentos e no alívio das tensões!"
            </p>
            <div className="flex items-center gap-3 pt-4 border-t border-black/5">
              <div className="w-10 h-10 rounded-full bg-[#0B3D66] text-white font-bold flex items-center justify-center text-sm">
                RC
              </div>
              <div>
                <span className="block font-bold text-sm text-[#17212B]">Rodrigo C.</span>
          ...
          <div className="bg-white p-8 rounded-3xl border border-[#0B3D66]/10 shadow-md flex flex-col justify-between">
            ...
            <div className="flex items-center gap-3 pt-4 border-t border-black/5">
              <div className="w-10 h-10 rounded-full bg-[#1769AA] text-white font-bold flex items-center justify-center text-sm">
                MA
              </div>
              <div>
                <span className="block font-bold text-sm text-[#17212B]">Mariana A.</span>
                <span className="text-xs text-amber-600 flex items-center gap-1">
                  ★★★★★ <span className="text-[10px] text-gray-500 font-mono-data">Paciente em Londrina</span>
                </span>
              </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-[#0B3D66]/10 shadow-md flex flex-col justify-between">
            <p className="text-sm text-[#17212B]/80 italic mb-6 leading-relaxed">
              "Recomendo de olhos fechados. Fiz minha reabilitação pós-cirúrgica aqui e a atenção da equipe da Rua Santos é impecável. Senti um excelente avanço na minha reabilitação e recuperei muito da minha mobilidade!"
            </p>
            <div className="flex items-center gap-3 pt-4 border-t border-black/5">
              <div className="w-10 h-10 rounded-full bg-[#0B3D66] text-white font-bold flex items-center justify-center text-sm">
                FL
              ...
              <div>
                <span className="block font-bold text-sm text-[#17212B]">Fernanda L.</span>
                <span className="text-xs text-amber-600 flex items-center gap-1">
                  ★★★★★ <span className="text-[10px] text-gray-500 font-mono-data">Paciente em Londrina</span>
                </span>
              </div>
      ...
      <footer id="contato" className="bg-[#0B3D66] text-white pt-20 pb-12 px-6 md:px-16 rounded-t-[4rem] border-t border-white/10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 pb-16 border-b border-white/10">
          ...
          <div className="lg:col-span-4 space-y-4">
            <h4 className="font-bold text-lg text-white mb-2 font-mono-data text-xs uppercase tracking-wider text-sky-300">
              Informações de Contato
            </h4>

            <div className="flex items-start gap-3 text-sm text-white/80">
              <MapPin className="w-5 h-5 text-[#1769AA] shrink-0 mt-0.5" />
              <div>
            ...
            <div className="flex items-center gap-3 text-sm text-white/80">
              <Phone className="w-5 h-5 text-[#1769AA] shrink-0" />
              <div>
        ...
        <div className="max-w-7xl mx-auto pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-white/50 font-mono-data gap-4">
          ...
          <div className="flex gap-6">
            ...
            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="text-sky-300 hover:underline font-bold">Atendimento WhatsApp</a>
          </div>
        </div>
      </footer>
