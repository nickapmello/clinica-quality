    ...
    <div className="relative w-full min-h-screen bg-[#F7FAFC] text-[#17212B] font-sans selection:bg-[#1769AA] selection:text-white">
      ...
      <section ref={heroRef} className="relative min-h-[100dvh] flex flex-col justify-end pt-32 pb-16 px-6 md:px-16 overflow-hidden bg-[#0B3D66] text-white rounded-b-[3rem] shadow-2xl">
        ...
        <div className="hero-anim relative z-10 grid grid-cols-2 md:grid-cols-4 gap-4 pt-12 mt-12 border-t border-white/10 max-w-5xl">
          ...
          <div>
            <span className="block text-2xl md:text-3xl font-bold text-sky-300 font-mono-data">100%</span>
      ...
      <section id="filosofia" ref={philosophyRef} className="py-32 px-6 md:px-16 bg-[#0B3D66] text-white rounded-[3rem] my-12 relative overflow-hidden shadow-2xl border border-white/10">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          <div className="mt-12 space-y-8">
            <p className="philosophy-text text-xl md:text-3xl text-white/70 font-light leading-relaxed">
        ...
        <div className="space-y-12">
          ...
          <div className="sticky-card sticky top-32 bg-[#06243E] text-white p-8 md:p-14 rounded-[3rem] shadow-2xl border border-white/10 flex flex-col md:flex-row justify-between items-center gap-10">
            <div className="flex-1">
              ...
              <ul className="space-y-2 text-xs font-mono-data text-white/90">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-sky-300" /> Alívio de tensão profunda</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-sky-300" /> Restauração do comprimento muscular</li>
              </ul>
            </div>
          ...
          <div className="sticky-card sticky top-36 bg-[#0B3D66] text-white p-8 md:p-14 rounded-[3rem] shadow-2xl border border-white/10 flex flex-col md:flex-row justify-between items-center gap-10">
            <div className="flex-1">
              ...
              <ul className="space-y-2 text-xs font-mono-data text-white/90">
                ...
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-sky-300" /> Autonomia e prevenção permanente</li>
              </ul>
            </div>
          ...
          <div className="bg-[#0B3D66] text-white p-8 md:p-10 rounded-[2.5rem] shadow-2xl border-2 border-[#1769AA] relative flex flex-col justify-between h-full transform md:-translate-y-4">
            ...
            <div>
              ...
              <ul className="space-y-3 text-xs text-white/90 mb-8">
                ...
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-sky-300" /> Liberação miofascial contínua</li>
